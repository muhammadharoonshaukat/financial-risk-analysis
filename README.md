...
This project demonstrates an end-to-end data analytics workflow using Power BI, DAX, and PostSQL.
...
•	Key observations: 
o	Auto purchase: Lawyers → 58.58% approval 
o	Home improvement: Teachers → 50.35% approval 
o	Medical expenses: Engineers/Artists → ~47% 
o	Small business: Teachers → 50% approval 
...
•	Flag: 
o	High withdrawals 
o	Large international transfers 
